...
st.set_page_config(
    page_title="11907 - Unsupervised Learning",
    page_icon="📊",
    layout="wide",
...
model_path = r'C:\Users\lenovo\Downloads\Unsupervised Learning (Praktek)\Unsupervised Learning (Praktek)\Tugas4_A_11907'
